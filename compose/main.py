...
def create_challenge_files(base_path):
    ...
    misnamed_files = [
        ...
        ("photomariage.pdf", "petit piege de fichier dupliqué qui ne l'est pas", "2024-02-15"),
        ...
        ("backup_db!.txt",
         "Sauvegarde avec des caractères illégaux dans le titre.", "2024-03-25"),
        ("photos été.jpg", "Une photo mal nommée, mélange d'espaces et de caractères spéciaux.", "2024-02-10"),
        ("Doc1", "Document inutile et très mal nommé.", "2024-03-05"),
        ("Doc2", "Document inutile et très mal nommé.", "2024-02-20"),
        ("Doc3", "Document inutile et très mal nommé.", "2024-01-15"),
        ("Doc4", "Document inutile et très mal nommé.", "2024-04-10"),
        ("Doc5", "Document inutile et très mal nommé.", "2024-03-30"),
        ("Doc6", "Document inutile et très mal nommé.", "2024-01-25"),
        ("Doc7", "Document inutile et très mal nommé.", "2024-04-05"),
        ("Doc8", "Document inutile et très mal nommé.", "2024-02-15"),
        ("Doc9", "Document inutile et très mal nommé.", "2024-01-10"),
        ...
        ("Doc13", "Document inutile et très mal nommé.", "2024-01-05"),
        ("Doc14", "Document inutile et très mal nommé.", "2024-03-01"),
        ("Doc15", "Document inutile et très mal nommé.", "2024-02-10"),
        ("Doc16", "Document inutile et très mal nommé.", "2024-01-20"),
